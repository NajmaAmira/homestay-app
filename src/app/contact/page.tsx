        ...
        <div className="max-w-screen-xl mx-auto py-20 px-4">
            <div className="grid md:grid-cols-2 gap-8">
                <div>
                    ...
                    <p className='text-gray-700 py-5'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laudantium repellendus ipsam qui illo odit rem?</p>
                    <ul className='list-item space-y-6 pt-8'>
                        ...
                        <li className='flex gap-5'>
                            ...
                            <div className="flex-1">
                                ...
                                <p>+62 21 7654 3210, +62 361 4455 6677</p>
                            </div>
                        </li>
                        <li className='flex gap-5'>
                            <div className="flex-none bg-gray-300 p-3 shadow-sm rounded-sm">
                            ...
                            <div className="flex-1">
                                ...
                                <p>Jl. Tugu Muda No. 88, Semarang 50249</p>
                            </div>
                        </li>
                    </ul>
                </div>

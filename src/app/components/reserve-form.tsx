...
import { addDays, AddDaysOptions } from "date-fns";
  ...
  return (
    <div>
        <form action="">
            ...
            <button type="submit" className="px-10 py-3 text-center font-semibold text-white w-full bg-orange-400 rounded-sm cursor-pointer hover: bg-orange-500">
                Reserve
            </button>
        </form>
    </div>

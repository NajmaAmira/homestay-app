    ...
    <div className="bg-white shadow-lg rounded-sm transition duration-100 hover:shadow-sm">
        ...
        <div className="p-8">
            ...
            <div className="flex items-center justify-between">
                ...
                <Link href={`/room/${room.id}`} className="px-6 py-2.5 md:px-10 md:py-3 font-semibold text-white bg-orange-400 rounded-sm hover:bg-orange-500 transition duration-150">Reserve Now</Link>
            </div>
        </div>
    </div>
  )

  ...
  return (
    <div className="relative h-screen text-white overflow-hidden">
        ...
        <div className="relative flex flex-col justify-center items-center h-full text-center">
            <h1 className="text-7xl font-extrabold leading-tight mb-3 capitalize">Reserve your luxury room</h1>
            <p className="text-xl text-gray-300 mb-8">Get special offer just for you today.</p>
            <div className="flex gap-5">
                <Link href="/room" className="bg-orange-400 text-white hover:bg-orange-500 py-2.5 px-6 md:px-10 text-lg font-semibold hover:scale-105 hover:shadow-lg">Reserve Now</Link>

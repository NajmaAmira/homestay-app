...
const Footer = () => {
  return (
    <footer className="bg-gray-900">
            ...
            <div className="grid md:grid-cols-3 gap-7">
                <div>
                    ...
                    <p className="text-gray-400">
                        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Corporis harum aliquid facilis quibusdam consequuntur distinctio?
                    </p>
                </div>
                <div>
        ...
        <div className="max-w-screen-xl mx-auto px-4 border-t border-gray-500 py-8 text-center text-base text-gray-500">&copy; Copyright 2025 | Najma Amira | All Right Reserved</div>
    </footer>
  )
}

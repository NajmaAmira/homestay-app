        ...
        <table className='w-full divide-y divide-gray-200'>
            <thead>
                <tr>
                    ...
                    <th className='px-6 py-3 w-32 text-sm font-bold text-gray-700 uppercase text-left'>Name</th>
                    <th className='px-6 py-3 w-32 text-sm font-bold text-gray-700 uppercase text-left'>Arrival</th>
                    <th className='px-6 py-3 w-32 text-sm font-bold text-gray-700 uppercase text-left'>Departure</th>
